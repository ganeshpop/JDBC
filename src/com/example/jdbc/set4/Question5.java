...
// retrieve all records under a project and order the result by employee name and department.
public class Question5 {
    public static void main(String[] args) {
        ...
        try {
            ...
            PreparedStatement getAssignments = connection.prepareStatement("SELECT EMPLOYEE_NAME, DEPARTMENT, PERFORMANCE FROM employees WHERE PROJECT = ? ORDER BY PROJECT;");
